...
public class ModeratorLoginPage {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("https://bombaystudios.in/moderator");
		...
		Boolean Email1 = driver.findElement(By.name("email")).isEnabled();
		...
		String Emptyemailfield = driver.findElement(By.id("email-error")).getText();
		...
		driver.findElement(By.name("password")).sendKeys("1508ritika");
		driver.findElement(By.className("text-inverse")).click();
		driver.findElement(By.xpath("//button[@type='submit']")).click();
		String EmptyEmail = driver.findElement(By.id("email-error")).getText();
		System.out.println("Empty Email-Id Field (Error): - " + EmptyEmail);

		// To Valid Email-Id And Empty Password Field.
		driver.findElement(By.name("email")).clear();
		driver.findElement(By.name("password")).clear();
		driver.findElement(By.name("email")).sendKeys("ritikajain025@gmail.com");
		driver.findElement(By.className("text-inverse")).click();
		driver.findElement(By.xpath("//button[@type='submit']")).click();
		...
		driver.findElement(By.name("email")).clear();
		driver.findElement(By.name("password")).clear();
		driver.findElement(By.name("email")).sendKeys("ritikajain0250@gmail.com");
		driver.findElement(By.name("password")).sendKeys("1508ritika");
		driver.findElement(By.className("text-inverse")).click();
		driver.findElement(By.xpath("//button[@type='submit']")).click();
		...
		driver.findElement(By.name("password")).clear();
		driver.findElement(By.name("email")).sendKeys("ritikajain025@gmail.com");
		driver.findElement(By.name("password")).sendKeys("15080ritika");
		driver.findElement(By.className("text-inverse")).click();
		driver.findElement(By.xpath("//button[@type='submit']")).click();
		...
		driver.findElement(By.className("text-inverse")).click();
		driver.findElement(By.xpath("//button[@type='submit']")).click();
		System.out.println("Successfully Login By User");
		System.out.println("After Successfull Login URL Is : - " + driver.getCurrentUrl());
		System.out.println("After Successfull Login Title Is : - " + driver.getTitle());
	}
